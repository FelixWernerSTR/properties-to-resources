...
public class ManagementInfoResourceTest {
    ...
    @Inject
    [=mavenproject.entityName]Properties mock[=mavenproject.entityName]Properties;
    ...
    public void swaggerEnabled() {
        // Prepare test data
        Mockito.when(mock[=mavenproject.entityName]Properties.info().swagger().enable()).thenReturn(true);
    ...
    public void swaggerDisabled() {
        // Prepare test data
        Mockito.when(mock[=mavenproject.entityName]Properties.info().swagger().enable()).thenReturn(false);
