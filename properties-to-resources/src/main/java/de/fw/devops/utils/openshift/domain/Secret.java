 ...
 * Git sollten ja die Passwörter nicht in Klartext sein. Secret-Yaml-Files
 * dürfen auch nicht nach Nexus upgeloadet werden.
 * 
 * @author Felix Werner
 *
 */
...
public class Secret {
	...
	public String toString() {
		return "Secret [nameValue=" + nameValue + "]";
	}
	...
	public static List<String> getRegex() {
		...
		for (Field field : fields) {
			fieldList.add(Secret.class.getSimpleName().toLowerCase() + PropertiesToPojosParseUtil.REGEX_PATTERN_CORE
					+ field.getName());
		}
		return fieldList;
	}
