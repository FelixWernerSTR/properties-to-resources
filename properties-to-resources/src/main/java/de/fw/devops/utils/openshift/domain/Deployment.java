...
public class Deployment {
	...
	String targetPathSuffix;// optional, wenn nicht Ã¼ber Namespace/StageSysproperty-mapping aufgelÃ¶st
							// werden kann
	String minReadySeconds;// optional
	String strategyType; // optional, möglichen Werte: RollingUpdate(default)/Recreate
	String rollingUpdateMaxUnavailable = "25%"; // wird gesetzt wenn strategyType=RollingUpdate. Man kann also auch
												// diesen default Wert übersteuern
	String rollingUpdateMaxSurge = "25%"; // wird gesetzt wenn strategyType=RollingUpdate. Man kann also auch diesen
											// default Wert übersteuern
	String readinessProbePath; // optional
	String ocBinaryPath; // optional: Pfad zum oc - OpenShift Command Line Interface, kann in sh/cmd
							// Skripten gesetzt werden zum Beispiel:
							// ${sys:basedir}/lib/oc/linux
	String ocServerUrl; // default: https://api.cntr.sv.loc:6443/
	// HorizontalPodAutoscaler konfiguration
	String autoscalerMinReplicas = "1";
	String autoscalerMaxReplicas = "2";
	String autoscalerMemoryUtilization = "95";
	String autoscalerCpuUtilization = "95";
	...
	public static List<String> getRegex() {
		...
		for (Field field : fields) {
			fieldList.add(Deployment.class.getSimpleName().toLowerCase()
					+ PropertiesToPojosParseUtil.REGEX_PATTERN_CORE_SINGLE_POJO + field.getName());
		}
		return fieldList;
	}

	/**
	 * @return the ocServerUrl
	 */
	public String getOcServerUrl() {
		return ocServerUrl;
	}

	/**
	 * @param ocServerUrl the ocServerUrl to set
	 */
	public void setOcServerUrl(String ocServerUrl) {
		this.ocServerUrl = ocServerUrl;
	}
	...
	public String getAutoscalerMinReplicas() {
		return autoscalerMinReplicas;
	}

	public void setAutoscalerMinReplicas(String autoscalerMinReplicas) {
		this.autoscalerMinReplicas = autoscalerMinReplicas;
	}

	public String getAutoscalerMaxReplicas() {
		return autoscalerMaxReplicas;
	}

	public void setAutoscalerMaxReplicas(String autoscalerMaxReplicas) {
		this.autoscalerMaxReplicas = autoscalerMaxReplicas;
	}

	public String getAutoscalerMemoryUtilization() {
		return autoscalerMemoryUtilization;
	}

	public void setAutoscalerMemoryUtilization(String autoscalerMemoryUtilization) {
		this.autoscalerMemoryUtilization = autoscalerMemoryUtilization;
	}

	public String getAutoscalerCpuUtilization() {
		return autoscalerCpuUtilization;
	}

	public void setAutoscalerCpuUtilization(String autoscalerCpuUtilization) {
		this.autoscalerCpuUtilization = autoscalerCpuUtilization;
	}
	...
	public String toString() {
		...
		builder.append(readinessProbePath);
		builder.append(", ocBinaryPath=");
		builder.append(ocBinaryPath);
		builder.append(", ocServerUrl=");
		builder.append(ocServerUrl);
		builder.append("]");
